...
final AtomicInteger for_task = new AtomicInteger(1);
...
void Do()
{
	...
	final int numSlaves = (JGFSeriesBenchSizeA.nthreads > 1) ? JGFSeriesBenchSizeA.nthreads -1 : 0;
...
private void calculateAterms(double omega) 
{
	
	for (int i = for_task.getAndIncrement(); i < array_rows; i = for_task.getAndIncrement())
    {
