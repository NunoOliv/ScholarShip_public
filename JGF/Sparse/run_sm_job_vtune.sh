...
Vtune_output_dir="/home/a67649/tese/benchmarks/ScholarShip_public/JGF/Sparse/JGF_original/Vtune_out/sm"
...
mkdir -p classes
# seq
javac -g -d ./classes ./sm/*.java
# Correr com VTune
# Criar pasta
mkdir -p "/home/a67649/tese/benchmarks/ScholarShip_public/JGF/Sparse/JGF_original/Vtune_out/sm"
cd $Vtune_output_dir

echo "Collecting HotSpots"
(>&2 echo "Collecting hotspots")
amplxe-cl -collect hotspots -- java -Xcomp -Djava.library.path=native_lib/ia32 -cp ${Project_Folder}/classes/ sm.Sm_jgf -size 5 4
